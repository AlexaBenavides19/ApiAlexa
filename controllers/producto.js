...
const putProducto = async (req, res = response) => {
    ...
    let mensaje = '';
    try {
        await Producto.findOneAndUpdate( { Nombreproducto: body.Nombreproducto,  categoria: body.categoria, precio: body.precio, cantidad:body.cantidad,  descripcionproducto: body.descripcionproducto  },);
